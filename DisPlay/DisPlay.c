...
//                  Í¼Æ¬Ö¸Õë          ¿í¶È             ¸ß¶È     Ðý×ª½Ç¶È  Ìî³äÑÕÉ«
...
{     
    ...
    Paint_NewImage(BlackImage1, EPD_1IN54_WIDTH, EPD_1IN54_HEIGHT, 90,    WHITE);
//                  Í¼Æ¬Ö¸Õ«          Â¿ñ²€             Â¸ß¶È     Ð½×ªÂ½Ç¶È  Ì®Â³ä‘•É«
    Paint_SelectImage(BlackImage1);
    Paint_Clear(WHITE);
...
void EPD_1IN54_test(void)
{
	DEV_Module_Init();//½Ó¿Ú¸ßµÍµçÆ½³õÊ¼»¯
    EPD_1IN54_Init();//  EPD_1IN54_FULL  0 È«ÆÁË¢ÐÂ      EPD_1IN54_PART  1   ¾Ö²¿Ë¢ÐÂ
    EPD_1IN54_Clear();             //ÇåÆÁ
    DEV_Delay_ms(500);	
    //´´½¨ÐÂµÄÍ¼Ïñ»º´æ
    UBYTE *BlackImage;
    UWORD Imagesize = ((EPD_1IN54_WIDTH % 8 == 0)? (EPD_1IN54_WIDTH / 8 ): (EPD_1IN54_WIDTH / 8 + 1)) * EPD_1IN54_HEIGHT;
